...
#   2. Asegúrese de tener instalados los paquetes tkinter, numpy y matplotlib.
...
class PumpCurveApp:
    ...
    def plot_initial_reference_curve(self):
        ...
        # Limpiar los ejes antes de graficar
        self.ax1.clear()
        # Graficar curva de carga vs caudal (H-Q) de la bomba de referencia
        ...
        # Graficar curva de eficiencia vs caudal (Eff-Q) de la bomba de referencia
        self.ax2.clear()
